...
#define cpu_map_h
  ...
  // 智能旋涂仪 remap: X=D2(PE4), Y=D4(PG5), Z=D6(PH3)
  ...
  #endif
  #define STEP_BIT_0 4  // X Step - D2 (PE4)
  #define STEP_BIT_1 5  // Y Step - D4 (PG5)
  #define STEP_BIT_2 3  // Z Step - D6 (PH3)
  #if N_AXIS > 3
  ...
  // 智能旋涂仪 remap: X=D3(PE5), Y=D5(PE3), Z=D7(PH4)
  #define DIRECTION_PORT_0 E
  #define DIRECTION_PORT_1 E
  ...
  #endif
  #define DIRECTION_BIT_0 5 // X Dir - D3 (PE5)
  #define DIRECTION_BIT_1 3 // Y Dir - D5 (PE3)
  #define DIRECTION_BIT_2 4 // Z Dir - D7 (PH4)
  #if N_AXIS > 3
  ...
  // 智能旋涂仪 remap: 限位都在 PORTA/PORTC（无 PCINT），用 ENABLE_RAMPS_HW_LIMITS 轮询
  // X-=D22(PA0)  Y-=D25(PA3)  Z-=D28(PA6)
  ...
  #endif
  #define MIN_LIMIT_BIT_0 0 // X Limit Min - D22 (PA0)
  #define MIN_LIMIT_BIT_1 3 // Y Limit Min - D25 (PA3)
  #define MIN_LIMIT_BIT_2 6 // Z Limit Min - D28 (PA6)
  #if N_AXIS > 3
  ...
  // X+=D24(PA2)  Y+=D27(PA5)  Z+=D30(PC7)  ← 用作 homing 触发
  ...
  #define MAX_LIMIT_BIT_1 5 // Y Limit Max - D27 (PA5)
  #define MAX_LIMIT_BIT_2 7 // Z Limit Max - D30 (PC7)
  #if N_AXIS > 3
  ...
  // 智能旋涂仪 remap: 默认的 D4/D5 与我们的 Y STEP/DIR 撞车，搬到 D40(PG1)/D41(PG0)
  // 我们没有 spindle 硬件，这两个 pin 实际没接东西，只是占位
  #define SPINDLE_ENABLE_DDR      DDRG
  #define SPINDLE_ENABLE_PORT     PORTG
  #define SPINDLE_ENABLE_BIT      1 // D40 (PG1)
  #define SPINDLE_DIRECTION_DDR   DDRG
  #define SPINDLE_DIRECTION_PORT  PORTG
  #define SPINDLE_DIRECTION_BIT   0 // D41 (PG0)
