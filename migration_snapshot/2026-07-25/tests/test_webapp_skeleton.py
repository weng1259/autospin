...
hardware:
  mock: true
  rs485: {port: /dev/test-rs485}
  spincoater: {backend: verified_adapter, port: /dev/test-rs485, slave_id: 2, baudrate: 9600, timeout_s: 2.0, max_rpm: 3000}
  heater: {backend: verified_adapter, port: /dev/test-rs485, slave_id: 3, baudrate: 9600, timeout_s: 3.0, sv_max_c: 150}
  pipette: {backend: verified_adapter, port: /dev/test-rs485, slave_id: 1, baudrate: 115200, timeout_s: 2.0, max_volume_ul: 1000}
  linear_stage: {backend: verified_adapter, port: /dev/test-rs485, address: 4, baudrate: 115200, timeout_s: 0.5, travel_mm: 100.0}
  relay: {port: /dev/test-relay, baudrate: 9600, channel_map: {}}
""",
        encoding="utf-8",
    )
